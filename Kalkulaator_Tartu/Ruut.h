...
#pragma region Windows Form Designer generated code
	...
	public:
		virtual void InitializeComponent(void)
		{
			...
			this->textBox1->KeyUp += gcnew System::Windows::Forms::KeyEventHandler(this, &Ruut::textBox1_KeyUp);
			// 
			// textBox2
			// 
			...
			this->textBox2->KeyUp += gcnew System::Windows::Forms::KeyEventHandler(this, &Ruut::textBox2_KeyUp);
			// 
			// textBox3
			// 
			...
			this->textBox3->KeyUp += gcnew System::Windows::Forms::KeyEventHandler(this, &Ruut::textBox3_KeyUp);
			// 
			// textBox4
			// 
			...
			this->textBox4->KeyUp += gcnew System::Windows::Forms::KeyEventHandler(this, &Ruut::textBox4_KeyUp);
			// 
			// comboBox1
			// 
			...
			this->comboBox1->SelectedIndexChanged += gcnew System::EventHandler(this, &Ruut::comboBox1_SelectedIndexChanged);
			// 
			// comboBox2
			// 
			...
			this->comboBox2->SelectedIndexChanged += gcnew System::EventHandler(this, &Ruut::comboBox2_SelectedIndexChanged);
			// 
			// comboBox3
			// 
			...
			this->comboBox3->SelectedIndexChanged += gcnew System::EventHandler(this, &Ruut::comboBox3_SelectedIndexChanged);
			// 
			// comboBox4
			// 
			...
			this->comboBox4->SelectedIndexChanged += gcnew System::EventHandler(this, &Ruut::comboBox4_SelectedIndexChanged);
			// 
			// label1
			// 
			...
			this->label5->Size = System::Drawing::Size(247, 87);
			this->label5->TabIndex = 20;
			this->label5->Text = L"SQUARE";
			// 
			// panel1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &Ruut::button1_Click);
			// 
			// Ruut
			// 
			...
			this->Load += gcnew System::EventHandler(this, &Ruut::Ruut_Load);
			this->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(this, &Ruut::Ruut_MouseDown);
			this->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &Ruut::Ruut_MouseMove);
			this->MouseUp += gcnew System::Windows::Forms::MouseEventHandler(this, &Ruut::Ruut_MouseUp);
...
void answReturner(double c, double a, double p, double s, int error, int j) { // siin tagastatakse töödeldud, kontrollitud ja arvutatud andmed õigetesse lahtritesse. Ainuke mida ei muudeta on lahter kuhu parasjagu kirjutatakse.
	...
	if (j != 2) {
		...
		if (error == 0) {textBox2->Text = unit(p, 2);
		}
		else { textBox2->Text = "ERROR"; }
}
	if (j != 3) {
		std::cout << "answR. 3" << std::endl;
		if (error == 0) {textBox3->Text = unit(s, 3);
		}
		else { textBox3->Text = "ERROR"; }
}
	if (j != 4) {
		std::cout << "answR. 4" << std::endl;
		if (error == 0) {textBox4->Text = unit(c, 4);
		}
...
private: System::Void Ruut_MouseMove(System::Object^  sender, System::Windows::Forms::MouseEventArgs^  e) {//2
		if (this->dragging) {
			Point currentScreenPos = PointToScreen(e->Location);// need 3 eventit tegelevad draggimisega.
			Location = Point(currentScreenPos.X - this->offset.X, currentScreenPos.Y - this->offset.Y);
		}
}
private: System::Void Ruut_MouseUp(System::Object^  sender, System::Windows::Forms::MouseEventArgs^  e) {//3
	this->dragging = false;
}
};}